...
module.exports = class Tic {
  ...
  updateGameStatus(testLocation){
    ...
    if (currentPositionStatus === '.'){
      let playerSymbol = this.currentTurn;
      this.gameStatus[positionX][positionY] = playerSymbol;

      // this.currentTurn = xOrO;
      this.numOfMoves += 1;
      // TODO: don't hardcode 5 size of board x 2 - 1
      if(this.numOfMoves >= 5 && this.checkForWin(playerSymbol)){
      ...
      playerSymbol = this.nextTurn();
      this.currentTurn = playerSymbol
